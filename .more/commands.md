...
### Git commands
   ...
   * pullFromMain - this command pulls (merges) changes from main/master branch and plays it in from of the changes from main/master into the current branch the
